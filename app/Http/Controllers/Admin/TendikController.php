...
class TendikController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.data.tendik.create', compact('agama', 'pendidikan', 'jabatan'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.data.tendik.edit', compact('tendik', 'agama', 'pendidikan', 'jabatan'));
    }
