...
<main class="p-10 space-y-8 animate-in">
    ...
    <!-- FORM EDIT -->
    <form action="{{ route('admin.data.siswa.update', $siswa->id_siswa ?? 1) }}" method="POST" class="bg-white rounded-[3rem] shadow-premium overflow-hidden border border-maroon-50">
        @csrf
        @method('PUT')
