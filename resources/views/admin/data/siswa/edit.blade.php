...
<main class="p-10 space-y-8 animate-in">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-2xl font-black text-maroon-950 tracking-tight italic">Edit Data Personel</h1>
        ...
        <div class="bg-rose-50/80 border border-rose-100 p-4 rounded-2xl mx-8 mt-8 flex items-start gap-3">
            ...
            <div>
                ...
                <p class="text-[11px] font-bold text-rose-600 mt-1">
                    Semua kolom yang memiliki tanda bintang merah (<span class="text-rose-600 text-sm align-top">*</span>) <span class="underline underline-offset-2">wajib diisi</span>. Jangan biarkan kosong sebelum menyimpan perubahan.
                </p>
            </div>
        </div>
        ...
        <div class="p-8 md:p-10 space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50 p-6 rounded-3xl border border-slate-200">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <div class="relative group">
                            <input id="passwordInput" type="password" name="password" minlength="6" placeholder="Biarkan kosong jika tidak ingin mengubah password..." class="w-full bg-white border border-slate-200 rounded-xl px-4 py-3.5 pr-12 text-sm font-bold text-slate-800 focus:ring-2 focus:ring-maroon-500 outline-none transition-all shadow-sm">
                        ...
                        <p class="text-[9px] font-bold text-amber-500 ml-1 mt-1 uppercase tracking-widest">* Hanya isi jika ingin mereset/mengganti password pengguna.</p>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50 p-6 rounded-3xl border border-slate-200">
                    <div class="space-y-2 md:col-span-2">
                        <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">
                            Status Magang <span class="text-rose-500 text-sm leading-none align-top">*</span>
                        </label>
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <input type="tel" inputmode="numeric" name="no_hp" value="{{ old('no_hp', $siswa->no_hp ?? '') }}" required placeholder="Contoh: 08123456789" oninput="this.value = this.value.replace(/[^0-9]/g, '')" class="w-full bg-white border border-slate-200 rounded-xl px-4 py-3.5 text-sm font-bold text-slate-800 focus:ring-2 focus:ring-maroon-500 outline-none transition-all shadow-sm">
                    </div>

                    <div class="space-y-2 md:col-span-2">
                        <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">
                            Pembimbing Lapangan <span class="text-rose-500 text-sm leading-none align-top">*</span>
                        </label>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="date" name="tanggal_mulai" value="{{ old('tanggal_mulai', $siswa->tanggal_mulai ?? '') }}" required class="w-full bg-white border border-slate-200 rounded-xl px-4 py-3.5 text-sm font-bold text-slate-800 focus:ring-2 focus:ring-maroon-500 outline-none transition-all cursor-pointer shadow-sm">
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="date" name="tanggal_selesai" value="{{ old('tanggal_selesai', $siswa->tanggal_selesai ?? '') }}" required class="w-full bg-white border border-slate-200 rounded-xl px-4 py-3.5 text-sm font-bold text-slate-800 focus:ring-2 focus:ring-maroon-500 outline-none transition-all cursor-pointer shadow-sm">
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="flex items-center gap-3 border-b border-maroon-50 pb-4 mb-6">
                    ...
                    <div>
                        <h3 class="text-lg font-black text-slate-800 tracking-tight uppercase italic leading-none">Detail Profil Tambahan</h3>
                        <p class="text-[10px] font-bold text-slate-400 mt-1 uppercase tracking-widest">KOLOM OPSIONAL BOLEH DIKOSONGKAN</p>
                    </div>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-transparent p-6 rounded-3xl border-2 border-dashed border-slate-300">

                    <div class="space-y-2 md:col-span-2">
                        <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Foto Profil</label>
                        @if($siswa->foto_profil)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $siswa->foto_profil) }}" alt="Foto Profil" class="w-20 h-20 rounded-xl object-cover border border-slate-200 shadow-sm">
                            </div>
                        @endif
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="sekolah_asal" value="{{ old('sekolah_asal', $siswa->sekolah_asal ?? '') }}" placeholder="Nama sekolah/instansi..." class="w-full bg-white border border-slate-200 rounded-xl px-4 py-3.5 text-sm font-bold text-slate-800 focus:ring-2 focus:ring-maroon-500 outline-none transition-all shadow-sm">
                    </div>
