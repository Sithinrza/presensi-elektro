...
<main class="p-10 space-y-8 animate-in">
    ...
    <!-- FORM TAMBAH -->
    <form id="formTambahSiswa" action="{{ route('admin.data.siswa.store') }}" method="POST" onsubmit="confirmSave(event)" class="bg-white rounded-3xl sm:rounded-[3rem] shadow-premium overflow-hidden border border-maroon-50">
        @csrf
