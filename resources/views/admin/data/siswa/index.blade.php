...
<main class="p-10 space-y-8 animate-in">
    ...
    <section class="flex flex-col xl:flex-row xl:items-center justify-between gap-6">
        <div class="flex items-center gap-4 p-2 bg-maroon-50 w-fit rounded-3xl border border-maroon-100">
            <div class="px-6 py-2">
                ...
                <p class="text-xl font-black text-maroon-950 tracking-tighter">32 Siswa</p>
            </div>
            ...
            <div class="px-6 py-2">
                ...
                <p class="text-xl font-black text-emerald-600 tracking-tighter">28 Orang</p>
            </div>
        </div>
    ...
    <section class="bg-white rounded-[3rem] border border-maroon-50 shadow-premium overflow-hidden">
        ...
        <div class="px-10 py-8 border-b border-maroon-50 flex items-center justify-between bg-white">
            <div class="relative">
                <input type="text" placeholder="Cari NIS atau Nama..." class="bg-slate-50 border border-slate-100 rounded-xl px-10 py-2.5 text-xs font-medium w-80 focus:ring-2 focus:ring-maroon-500 outline-none transition-all">
            ...
            <div class="flex items-center gap-3">
                <select class="bg-slate-50 border border-slate-100 rounded-xl px-4 py-2.5 text-[10px] font-black text-maroon-900 outline-none uppercase tracking-widest">
                    ...
                    <option>SMKN 5 Banjarmasin</option>
                    <option>SMK Negeri 2 Banjarmasin</option>
                </select>
            </div>
        </div>
                    ...
                    <tr class="hover:bg-maroon-50/20 transition-all duration-200 group">
                        <td class="px-10 py-5">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="text-sm font-extrabold text-slate-800 leading-none tracking-tight group-hover:text-maroon-900 transition-colors">Ahmad Fauzi</p>
                                    <p class="text-[9px] font-bold text-slate-400 mt-1.5 uppercase">ahmad.fauzi@email.com</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-10 py-5">
                            <p class="text-xs font-bold text-slate-500">2021006721</p>
                        </td>
                        <td class="px-10 py-5">
                            <p class="text-xs font-bold text-slate-600 uppercase tracking-tight leading-none">SMKN 5 Banjarmasin</p>
                            <p class="text-[9px] font-bold text-slate-300 mt-1 uppercase">TKJ - XII</p>
                        </td>
                    ...
                    <tr class="hover:bg-maroon-50/20 transition-all duration-200 group">
                        <td class="px-10 py-5">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="text-sm font-extrabold text-slate-800 leading-none tracking-tight group-hover:text-maroon-900 transition-colors">Budi Santoso</p>
                                    <p class="text-[9px] font-bold text-slate-400 mt-1.5 uppercase">budi.san@email.com</p>
                                </div>
                            </div>
                        </td>
                        <td class="px-10 py-5">
                            <p class="text-xs font-bold text-slate-500">2021004523</p>
                        </td>
                        <td class="px-10 py-5">
                            <p class="text-xs font-bold text-slate-600 uppercase tracking-tight leading-none">SMK Negeri 2 Banjarmasin</p>
                            <p class="text-[9px] font-bold text-slate-300 mt-1 uppercase">Elektro - XI</p>
                        </td>
                        <td class="px-10 py-5 text-center">
                            <span class="px-3 py-1 bg-emerald-100 text-emerald-600 rounded-lg text-[9px] font-black uppercase tracking-tighter">Aktif</span>
                        </td>
        ...
        <div class="px-10 py-8 border-t border-maroon-50 flex items-center justify-between bg-white">
            <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Halaman 1 dari 4 • Total 32 data</p>
            <div class="flex gap-2">
                <button class="w-10 h-10 rounded-xl border border-maroon-50 flex items-center justify-center text-maroon-900 bg-white hover:bg-maroon-50 active:scale-90 transition-all shadow-sm"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="m15 18-6-6 6-6"/></svg></button>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-maroon-100 max-h-[90vh] flex flex-col">
            ...
            <div class="p-8 space-y-6 overflow-y-auto no-scrollbar">
                <div class="grid grid-cols-2 gap-6">
                    <!-- Nama Lengkap -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-maroon-900 uppercase tracking-widest ml-1">Nama Lengkap</label>
                        <input type="text" placeholder="Masukkan nama..." class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-maroon-950 focus:ring-2 focus:ring-maroon-500 outline-none">
                    </div>
                    <!-- NIS -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-maroon-900 uppercase tracking-widest ml-1">NIS / Nomor Induk</label>
                        <input type="text" placeholder="Masukkan nomor induk..." class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-maroon-950 focus:ring-2 focus:ring-maroon-500 outline-none">
                    </div>
                    <!-- Email -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-maroon-900 uppercase tracking-widest ml-1">Email Sekolah/Instansi</label>
                        <input type="email" placeholder="contoh@sekolah.id" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-maroon-950 focus:ring-2 focus:ring-maroon-500 outline-none">
                    </div>
                    <!-- Sekolah Asal -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-maroon-900 uppercase tracking-widest ml-1">Sekolah Asal</label>
                        <input type="text" placeholder="Nama sekolah..." class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-maroon-950 focus:ring-2 focus:ring-maroon-500 outline-none">
                    </div>
                    <!-- Jurusan -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-maroon-900 uppercase tracking-widest ml-1">Jurusan / Kelas</label>
                        <input type="text" placeholder="Contoh: TKJ / XII" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-maroon-950 focus:ring-2 focus:ring-maroon-500 outline-none">
                    </div>
                    <!-- Password -->
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-maroon-900 uppercase tracking-widest ml-1 text-nowrap">Password (Default)</label>
                        <input type="password" value="123456" class="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-maroon-950 focus:ring-2 focus:ring-maroon-500 outline-none">
                    </div>
                </div>

                <!-- Face Data / Liveness Note -->
                <div class="p-4 bg-maroon-50 rounded-2xl border border-maroon-100 flex items-start gap-3">
                    <div class="w-8 h-8 bg-maroon-900 text-white rounded-lg flex items-center justify-center shrink-0">
                    ...
                    <p class="text-[10px] font-bold text-maroon-800 leading-relaxed italic uppercase">
                        Siswa akan diminta melakukan pendaftaran wajah (Face Enrollment) secara mandiri saat login pertama kali untuk sistem Liveness Detection.
                    </p>
                </div>
            </div>
            ...
            <div class="p-8 pt-0 shrink-0 flex gap-4">
                ...
                <button class="flex-2 bg-maroon-950 text-white py-4 px-10 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl active:scale-95 transition-all hover:bg-maroon-800">Simpan Data Siswa</button>
            </div>
        </div>
    </div>
</div>
