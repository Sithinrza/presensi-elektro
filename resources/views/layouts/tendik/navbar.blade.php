...
<header class="sticky top-0 z-40 glass-effect border-b border-maroon-100/30 px-5 lg:px-10 py-4">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-sm md:text-lg font-extrabold text-maroon-950 leading-none tracking-tight">Bapak/Ibu Tendik</h1>
                <p class="hidden md:block text-[10px] font-bold text-gold-dark uppercase tracking-widest mt-1">Staf Jurusan Teknik Elektro</p>
            </div>
        </div>
        <div class="flex items-center gap-3">
            ...
            <div class="w-10 h-10 rounded-full border-2 border-gold p-0.5 shadow-sm">
                <img src="https://i.pravatar.cc/100?img=12" alt="Profile" class="w-full h-full rounded-full object-cover">
            </div>
        </div>
    </div>
</header>
