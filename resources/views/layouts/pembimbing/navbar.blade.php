...
<header class="sticky top-0 z-40 glass-effect border-b border-maroon-100/30 px-5 lg:px-10 py-4 bg-white/80 backdrop-blur-md">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div class="flex items-center gap-4">
            ...
            <button class="relative w-10 h-10 flex items-center justify-center rounded-xl bg-maroon-50 text-maroon-900 active:scale-90 transition">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <button @click="open = !open" class="w-10 h-10 rounded-full border-2 border-gold p-0.5 block focus:outline-none active:scale-95 transition-transform overflow-hidden bg-white">
