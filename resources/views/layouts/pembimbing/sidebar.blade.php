...
<aside class="hidden lg:flex fixed left-0 top-0 h-full w-28 bg-maroon-950 flex-col items-center py-8 z-50 border-r border-white/5 shadow-2xl">
    ...
    <div class="flex flex-col gap-3 flex-1 w-full px-3">
        ...
        class="group nav-transition flex flex-col items-center justify-center py-4 rounded-[2rem] {{ request()->routeIs('pembimbing.nilai.*') ? 'bg-white text-maroon-950 shadow-xl scale-105' : 'text-white/40 hover:bg-white/5 hover:text-white' }}">
