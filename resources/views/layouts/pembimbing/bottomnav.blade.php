    ...
    <div class="max-w-md mx-auto">
        <div class="bg-maroon-950/95 backdrop-blur-2xl rounded-[2.5rem] p-2.5 flex justify-between items-center shadow-2xl shadow-maroon-950/40 border border-white/10">
            ...
            <a href="{{ route('pembimbing.monitoring.index') }}"
               class="w-14 h-14 flex items-center justify-center rounded-full transition-all duration-300 {{ request()->is('pembimbing/monitoring*') ? 'bg-white text-maroon-950 shadow-xl' : 'text-white/50' }}">
