    ...
    <div class="max-w-md mx-auto">
        <div class="bg-maroon-950/95 backdrop-blur-2xl rounded-[2.5rem] p-2 flex justify-between items-center shadow-2xl shadow-maroon-950/40 border border-white/10">
            ...
            <a href="{{ route('pembimbing.profil.index') }}"
                class="flex-1 flex flex-col items-center justify-center py-3 rounded-[2rem] transition-all duration-300 {{ request()->Routeis('pembimbing.profil.index') ? 'bg-white text-maroon-950 shadow-lg scale-105' : 'text-white/40' }}">
