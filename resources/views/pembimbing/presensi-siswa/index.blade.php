                    ...
                    <div class="mt-auto space-y-2">
                        <div class="grid grid-cols-3 gap-2">
                            <div class="bg-emerald-50/70 border border-emerald-100 rounded-xl sm:rounded-2xl p-2 sm:p-3 text-center group-hover:bg-emerald-50 transition-colors">
                                <p class="text-lg sm:text-xl font-black text-emerald-600 leading-none">{{ $s->stat_tepat_ci }}</p>
                            ...
                            <div class="bg-amber-50/70 border border-amber-100 rounded-xl sm:rounded-2xl p-2 sm:p-3 text-center group-hover:bg-amber-50 transition-colors">
                                <p class="text-lg sm:text-xl font-black text-amber-500 leading-none">{{ $s->stat_telat_ci }}</p>
                            ...
                            <div class="bg-rose-50/70 border border-rose-100 rounded-xl sm:rounded-2xl p-2 sm:p-3 text-center group-hover:bg-rose-50 transition-colors">
                                <p class="text-lg sm:text-xl font-black text-rose-500 leading-none">{{ $s->stat_alfa }}</p>
                                <p class="text-[8px] font-bold text-rose-700/60 uppercase tracking-widest mt-1.5 line-clamp-1">Alfa</p>
                            </div>
                        </div>

                        <div class="grid grid-cols-3 gap-1.5">
                            <div class="bg-slate-50 border border-slate-100 rounded-xl p-2 flex flex-col justify-center items-center group-hover:border-emerald-100 transition-colors">
                                <span class="text-[7px] sm:text-[8px] font-black text-slate-400 uppercase tracking-wider">Tepat CO</span>
                                <span class="text-xs sm:text-sm font-black text-slate-700 mt-1">{{ $s->stat_tepat_co }}</span>
                            </div>
                            <div class="bg-slate-50 border border-slate-100 rounded-xl p-2 flex flex-col justify-center items-center group-hover:border-amber-100 transition-colors">
                                <span class="text-[7px] sm:text-[8px] font-black text-slate-400 uppercase tracking-wider">Telat CO</span>
                                <span class="text-xs sm:text-sm font-black text-amber-500 mt-1">{{ $s->stat_telat_co }}</span>
                            </div>
                            <div class="bg-slate-50 border border-slate-100 rounded-xl p-2 flex flex-col justify-center items-center group-hover:border-rose-100 transition-colors">
                                <span class="text-[7px] sm:text-[8px] font-black text-slate-400 uppercase tracking-wider">Lupa CO</span>
                                <span class="text-xs sm:text-sm font-black text-rose-500 mt-1">{{ $s->stat_lupa_co }}</span>
                            </div>
                        </div>
                    </div>
                </div>
