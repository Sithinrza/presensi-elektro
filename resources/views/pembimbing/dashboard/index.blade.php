    ...
    <section class="animate-in space-y-4 lg:space-y-6" style="animation-delay: 0.3s">
        <div class="flex items-center justify-between px-1 lg:px-2">
            <div class="flex items-center gap-2 lg:gap-3">
                ...
                <h3 class="text-lg lg:text-2xl font-black text-maroon-950 tracking-tight">Peserta Magang Aktif</h3>
            </div>
            <a href="{{ route('pembimbing.data-siswa.index') }}" class="text-[9px] lg:text-xs font-black text-maroon-700 uppercase underline tracking-widest hover:text-maroon-900 transition-colors">Lihat Semua Data</a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-6">
            ...
            @empty
                <div class="md:col-span-2 xl:col-span-3 bg-white/50 backdrop-blur-sm rounded-[2rem] lg:rounded-[3rem] border-2 border-dashed border-maroon-100 p-8 lg:p-12 text-center flex flex-col items-center justify-center">
                    ...
                    <h4 class="text-lg lg:text-xl font-black text-maroon-950 tracking-tight mb-2">Semua Aman!</h4>
                    <p class="text-xs lg:text-sm font-medium text-slate-500 max-w-md">Saat ini tidak ada siswa bimbingan yang berstatus aktif di bawah pengawasan Anda.</p>
                </div>
            @endforelse
