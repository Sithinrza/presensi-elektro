...
<head>
  ...
  <title>Sistem Presensi - Jurusan Teknik Elektro Poliban</title>
  ...
  <header class="fixed top-0 w-full z-50 glass-nav transition-all duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
      ...
      <nav class="hidden lg:flex items-center gap-8 text-xs font-bold text-white/80 uppercase tracking-widest">
        ...
        <a href="#fitur" class="hover:text-gold transition-colors">Fasilitas</a>
        <a href="#tentang" class="hover:text-gold transition-colors">Info Sistem</a>
      </nav>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
      ...
      <div class="space-y-6 sm:space-y-8 animate-fade-up z-10 text-center lg:text-left pt-8 lg:pt-0">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 justify-center lg:justify-start pt-2 sm:pt-4 w-full px-4 sm:px-0">
          <a href="{{ url('/login') }}" class="w-full sm:w-auto bg-white text-maroon-950 px-6 sm:px-8 py-3.5 sm:py-4 rounded-full font-black text-[10px] sm:text-xs uppercase tracking-widest shadow-xl hover:bg-slate-50 hover:-translate-y-1 transition-all flex items-center justify-center gap-2">
            Lakukan Presensi
          </a>
      ...
      <div class="relative hidden lg:block animate-fade-up z-10" style="animation-delay: 0.2s;">
        <div class="absolute -left-4 top-10 w-24 h-24 bg-white/5 backdrop-blur-lg rounded-2xl border border-white/20 flex items-center justify-center animate-float-slow shadow-2xl z-20">
        ...
        <div class="absolute right-0 bottom-20 w-28 h-28 bg-maroon-600/20 backdrop-blur-lg rounded-full border border-maroon-400/30 flex items-center justify-center animate-float-fast shadow-2xl z-20">
        ...
        <div class="relative flex justify-center items-center transform hover:-translate-y-4 transition-transform duration-500">
            <img src="{{ asset('img/ilustrasi.png') }}" alt="Ilustrasi Face Liveness" class="w-10/12 max-h-[500px] object-contain drop-shadow-[0_20px_40px_rgba(0,0,0,0.5)] z-10">

            <div class="absolute -bottom-4 left-6 right-6 z-20 glass-card rounded-2xl p-4 flex items-center gap-4 border-l-4 border-l-emerald-400">
                ...
                <div>
                    <p class="text-xs font-bold text-slate-800">Presensi Berhasil Disimpan</p>
                    <p class="text-[10px] text-slate-500 font-medium">Wajah terdeteksi asli dan koordinat lokasi telah sesuai.</p>
                </div>
            </div>
        </div>
      </div>
  ...
  <section id="fitur" class="py-16 sm:py-24 relative overflow-hidden bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
      ...
      <div class="text-center max-w-2xl mx-auto mb-12 sm:mb-16">
        ...
        <h3 class="font-heading text-2xl sm:text-3xl md:text-4xl font-extrabold text-maroon-950 mt-3 sm:mt-4 mb-3 sm:mb-4 tracking-tight">Fasilitas Utama Sistem</h3>
        <p class="text-slate-500 text-sm md:text-base leading-relaxed px-2 sm:px-0">
          Meninggalkan metode pencatatan konvensional. Sistem ini dirancang untuk mempermudah pemantauan dan penyusunan laporan kehadiran secara digital.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-6 gap-5 sm:gap-6 lg:gap-8">
        ...
        <div class="bg-white rounded-[1.5rem] sm:rounded-[2rem] p-6 sm:p-8 shadow-sm border border-slate-100 hover:-translate-y-2 hover:shadow-soft transition-all duration-300 group xl:col-span-2">
          ...
          <h4 class="text-lg sm:text-xl font-extrabold text-maroon-950 mb-2.5 sm:mb-3 tracking-tight">Teknologi Face Liveness</h4>
          <p class="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
            Sistem mampu mengenali wajah asli secara langsung, sehingga meminimalisir kemungkinan manipulasi data presensi menggunakan foto.
          </p>
        </div>
        ...
        <div class="bg-white rounded-[1.5rem] sm:rounded-[2rem] p-6 sm:p-8 shadow-sm border border-slate-100 hover:-translate-y-2 hover:shadow-soft transition-all duration-300 group xl:col-span-2">
          ...
          <h4 class="text-lg sm:text-xl font-extrabold text-maroon-950 mb-2.5 sm:mb-3 tracking-tight">Logbook Kegiatan Harian</h4>
          <p class="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
            Fasilitas pelaporan kegiatan khusus bagi Siswa Magang, yang memungkinkan pembimbing lapangan untuk memantau progres tugas dengan mudah.
          </p>
        </div>
        ...
        <div class="bg-white rounded-[1.5rem] sm:rounded-[2rem] p-6 sm:p-8 shadow-sm border border-slate-100 hover:-translate-y-2 hover:shadow-soft transition-all duration-300 group xl:col-span-2 xl:col-start-2">
          ...
          <h4 class="text-lg sm:text-xl font-extrabold text-maroon-950 mb-2.5 sm:mb-3 tracking-tight">Rekapitulasi Kehadiran</h4>
          <p class="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
            Seluruh data kehadiran, keterlambatan, hingga rekapitulasi akhir tersusun secara otomatis, menyederhanakan proses evaluasi bagi Administrator.
          </p>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
      ...
      <div class="space-y-5 sm:space-y-6 text-center lg:text-left">
        ...
        <p class="text-maroon-100/80 leading-relaxed text-sm sm:text-base px-2 sm:px-0">
          Sistem Presensi ini dikembangkan guna mengalihkan proses pencatatan kehadiran yang sebelumnya dilakukan secara manual menjadi lebih rapi dan terpusat dalam satu basis data.
        </p>
        <p class="text-maroon-100/80 leading-relaxed text-sm sm:text-base px-2 sm:px-0">
          Langkah digitalisasi ini bertujuan untuk menghemat waktu operasional serta mempermudah rekapitulasi pelaporan evaluasi kedisiplinan Tenaga Kependidikan dan Siswa Magang.
        </p>
        ...
        <div class="pt-4 sm:pt-6 grid grid-cols-2 gap-4 sm:gap-8 justify-center lg:justify-start">
            <div>
                ...
                <p class="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-maroon-200 mt-1.5 sm:mt-2">Level Akses Pengguna</p>
            </div>
            <div>
                <p class="text-3xl sm:text-4xl font-black text-gold">100%</p>
                <p class="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-maroon-200 mt-1.5 sm:mt-2">Sistem Digital</p>
            </div>
        </div>
      </div>
      ...
      <div class="grid gap-3 sm:gap-4 sm:grid-cols-2 mt-8 lg:mt-0">
        <div class="bg-white/10 backdrop-blur-md rounded-2xl sm:rounded-3xl p-5 sm:p-6 border border-white/10 hover:bg-white/15 transition-colors">
            ...
            <p class="text-[11px] sm:text-xs text-white/60 leading-relaxed">Pencatatan presensi masuk dan pulang bagi staf administrasi serta teknisi laboratorium yang terhubung langsung dengan sistem utama.</p>
        </div>
        ...
        <div class="bg-white/10 backdrop-blur-md rounded-2xl sm:rounded-3xl p-5 sm:p-6 border border-white/10 hover:bg-white/15 transition-colors sm:translate-y-8">
            ...
            <p class="text-[11px] sm:text-xs text-white/60 leading-relaxed">Fasilitas khusus untuk merekam kehadiran setiap pagi, sekaligus mendokumentasikan progres pekerjaan selama masa magang berlangsung.</p>
        </div>
        ...
        <div class="bg-white/10 backdrop-blur-md rounded-2xl sm:rounded-3xl p-5 sm:p-6 border border-white/10 hover:bg-white/15 transition-colors">
            ...
            <p class="text-[11px] sm:text-xs text-white/60 leading-relaxed">Memberikan akses bagi pembimbing untuk memantau rutinitas harian siswa magang serta memberikan penilaian akhir praktik secara daring.</p>
        </div>
        ...
        <div class="bg-white/10 backdrop-blur-md rounded-2xl sm:rounded-3xl p-5 sm:p-6 border border-white/10 hover:bg-white/15 transition-colors sm:translate-y-8">
            ...
            <p class="text-[11px] sm:text-xs text-white/60 leading-relaxed">Memiliki otoritas penuh dalam pengelolaan profil pengguna, penyesuaian jadwal operasional, hingga pencetakan laporan dan sertifikat akhir.</p>
        </div>
      </div>
  ...
  <section class="py-16 sm:py-24 relative bg-white">
    <div class="max-w-5xl mx-auto px-4 sm:px-6">
      <div class="bg-white rounded-[2rem] sm:rounded-[3rem] p-8 sm:p-10 md:p-16 text-center shadow-premium border border-slate-100 relative overflow-hidden">
        ...
        <h3 class="font-heading text-2xl sm:text-3xl md:text-5xl font-extrabold text-maroon-950 mb-3 sm:mb-4 relative z-10 tracking-tight">Akses Panel Pengguna</h3>
        <p class="text-slate-500 max-w-xl mx-auto mb-8 sm:mb-10 text-xs sm:text-sm md:text-base relative z-10 px-2 sm:px-0">
          Silakan menggunakan kredensial akun yang telah didaftarkan oleh Administrator untuk masuk ke dalam sistem. Jangan lupa untuk memberikan izin akses kamera dan lokasi pada perangkat Anda.
        </p>

        <a href="{{ url('/login') }}" class="flex sm:inline-flex items-center justify-center w-full sm:w-auto gap-2 sm:gap-3 bg-maroon-950 text-white px-6 sm:px-10 py-4 sm:py-5 rounded-xl sm:rounded-2xl font-black text-[10px] sm:text-xs uppercase tracking-widest hover:bg-maroon-800 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 active:scale-95 relative z-10">
            Masuk ke Sistem
