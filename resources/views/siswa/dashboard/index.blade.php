                ...
                <div class="relative z-10 space-y-6 sm:space-y-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                        ...
                        @elseif(!$presensiHariIni)
                            <a href="{{ route('presensi.index') }}" class="sm:col-span-2 group bg-white rounded-[1.5rem] sm:rounded-[2rem] p-5 sm:p-6 flex items-center gap-4 shadow-xl hover:shadow-2xl active:scale-95 transition-all">
                                <div class="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-2xl flex items-center justify-center group-hover:bg-emerald-600 group-hover:text-white transition-all shrink-0">
                                ...
                                <div class="flex-1">
                                    <span class="block text-maroon-950 font-black text-base uppercase tracking-wide leading-none">Presensi Masuk</span>
                                    <span class="text-[9px] text-slate-400 font-bold uppercase tracking-widest mt-1">Sistem Telah Dibuka</span>
                                </div>
                        ...
                        @elseif($presensiHariIni && is_null($presensiHariIni->jam_pulang))
                            ...
                            <a href="{{ route('presensi.index') }}" class="group bg-maroon-800 border border-white/10 rounded-[1.5rem] sm:rounded-[2rem] p-5 sm:p-6 flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-3 sm:gap-4 active:scale-95 transition-all hover:bg-rose-900/40 hover:border-rose-500/30">
                                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-white/10 text-maroon-100 rounded-xl sm:rounded-2xl flex items-center justify-center group-hover:bg-rose-500 group-hover:text-white transition-all shrink-0">
                                ...
                                <div class="text-center sm:text-left">
                                    <span class="block text-white font-black text-base uppercase tracking-wide leading-none">Presensi Pulang</span>
                                    <span class="text-[9px] text-maroon-200/50 font-bold uppercase tracking-widest mt-1">End Session</span>
                                </div>
                            </a>
